...
#define MSG2133_I2C_ADDR        (0x4c >> 1)
...
static struct i2c_board_info __initdata msg2133_i2c_tpd = {
    I2C_BOARD_INFO(MSG2133_I2C_NAME, MSG2133_I2C_ADDR)
};

static void tpd_eint_interrupt_handler(void);
static int msg2133_i2c_probe(struct i2c_client *client,
                             const struct i2c_device_id *id);
static int msg2133_i2c_detect(struct i2c_client *client,
...
static int msg2133_i2c_read(unsigned char *packet)
{
    ...
    i2c_client->addr = (MSG2133_I2C_ADDR & I2C_MASK_FLAG) | I2C_ENEXT_FLAG;
