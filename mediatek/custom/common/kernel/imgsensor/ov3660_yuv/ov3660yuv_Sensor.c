...
static void OV3660_IQ(void)
{
	...
	OV3660_write_cmos_sensor(0x3a19, 0x3f); 
	//AWB
	...
	OV3660_write_cmos_sensor(0x5186, 0x14); 
	OV3660_write_cmos_sensor(0x5187, 0x20);  
	OV3660_write_cmos_sensor(0x5188, 0x12); 
	OV3660_write_cmos_sensor(0x5189, 0x7a);  
	OV3660_write_cmos_sensor(0x518a, 0x5e);  
	OV3660_write_cmos_sensor(0x518b, 0xe5);  
	OV3660_write_cmos_sensor(0x518c, 0xc5);  
	OV3660_write_cmos_sensor(0x518d, 0x43);  
	OV3660_write_cmos_sensor(0x518e, 0x3a);  
	OV3660_write_cmos_sensor(0x518f, 0x56);  
	OV3660_write_cmos_sensor(0x5190, 0x4d);  
	...
	OV3660_write_cmos_sensor(0x5198, 0x05); 
	OV3660_write_cmos_sensor(0x5199, 0x37);  
	OV3660_write_cmos_sensor(0x519a, 0x04); 
	OV3660_write_cmos_sensor(0x519b, 0x00); 
	OV3660_write_cmos_sensor(0x519c, 0x07); 
	OV3660_write_cmos_sensor(0x519d, 0x29);  
	OV3660_write_cmos_sensor(0x519e, 0x38);  
	//CMX
	OV3660_write_cmos_sensor(0x5381, 0x1c);
	OV3660_write_cmos_sensor(0x5382, 0x5d);
	OV3660_write_cmos_sensor(0x5383, 0x03);
	OV3660_write_cmos_sensor(0x5384, 0x0c);
	OV3660_write_cmos_sensor(0x5385, 0x78);
	OV3660_write_cmos_sensor(0x5386, 0x83);
	OV3660_write_cmos_sensor(0x5387, 0x7d);
	OV3660_write_cmos_sensor(0x5388, 0x6b);
	OV3660_write_cmos_sensor(0x5389, 0x12);
	OV3660_write_cmos_sensor(0x538b, 0x98);
	OV3660_write_cmos_sensor(0x538a, 0x01); 

	//;CIP
	OV3660_write_cmos_sensor(0x5300, 0x0c);
	OV3660_write_cmos_sensor(0x5301, 0x20);
	OV3660_write_cmos_sensor(0x5302, 0x10);
	OV3660_write_cmos_sensor(0x5303, 0x00);
	OV3660_write_cmos_sensor(0x5304, 0x0c);
	OV3660_write_cmos_sensor(0x5305, 0x20);
	OV3660_write_cmos_sensor(0x5306, 0x0c);
	OV3660_write_cmos_sensor(0x5307, 0x20);
	OV3660_write_cmos_sensor(0x5309, 0x0c);
	OV3660_write_cmos_sensor(0x530a, 0x20);
	OV3660_write_cmos_sensor(0x530b, 0x00);
	OV3660_write_cmos_sensor(0x530c, 0x10);

		//;gamma
	OV3660_write_cmos_sensor(0x5000, 0x27); 
	OV3660_write_cmos_sensor(0x5481, 0x08);  
	OV3660_write_cmos_sensor(0x5482, 0x14);  
	OV3660_write_cmos_sensor(0x5483, 0x28);  
	OV3660_write_cmos_sensor(0x5484, 0x51);  
	OV3660_write_cmos_sensor(0x5485, 0x65);  
	OV3660_write_cmos_sensor(0x5486, 0x71);  
	OV3660_write_cmos_sensor(0x5487, 0x7d);  
	OV3660_write_cmos_sensor(0x5488, 0x87);  
	OV3660_write_cmos_sensor(0x5489, 0x91);  
	OV3660_write_cmos_sensor(0x548a, 0x9a);  
	OV3660_write_cmos_sensor(0x548b, 0xaa);  
	OV3660_write_cmos_sensor(0x548c, 0xb8);  
	OV3660_write_cmos_sensor(0x548d, 0xcd);  
	OV3660_write_cmos_sensor(0x548e, 0xdd);  
	OV3660_write_cmos_sensor(0x548f, 0xea);   
	OV3660_write_cmos_sensor(0x5490, 0x1d);   

	//;UV adjust
	OV3660_write_cmos_sensor(0x5001, 0xa7);
	OV3660_write_cmos_sensor(0x5580, 0x02); 
	OV3660_write_cmos_sensor(0x5583, 0x40);
	OV3660_write_cmos_sensor(0x5584, 0x30);
	OV3660_write_cmos_sensor(0x5589, 0x10);
	OV3660_write_cmos_sensor(0x558a, 0x00);
	OV3660_write_cmos_sensor(0x558b, 0x70);

	//;Lenc
	OV3660_write_cmos_sensor(0x5000, 0xa7);
	//;g
	OV3660_write_cmos_sensor(0x5800, 0x1a);
	OV3660_write_cmos_sensor(0x5801, 0x0d);
	OV3660_write_cmos_sensor(0x5802, 0x0b);
	OV3660_write_cmos_sensor(0x5803, 0x0b);
	OV3660_write_cmos_sensor(0x5804, 0x0d);
	OV3660_write_cmos_sensor(0x5805, 0x17);
	OV3660_write_cmos_sensor(0x5806, 0x0a);
	OV3660_write_cmos_sensor(0x5807, 0x06);
	OV3660_write_cmos_sensor(0x5808, 0x04);
	OV3660_write_cmos_sensor(0x5809, 0x04);
	OV3660_write_cmos_sensor(0x580a, 0x06);
	OV3660_write_cmos_sensor(0x580b, 0x09);
	OV3660_write_cmos_sensor(0x580c, 0x07);
	OV3660_write_cmos_sensor(0x580d, 0x03);
	OV3660_write_cmos_sensor(0x580e, 0x00);
	OV3660_write_cmos_sensor(0x580f, 0x00);
	OV3660_write_cmos_sensor(0x5810, 0x02);
	OV3660_write_cmos_sensor(0x5811, 0x06);
	OV3660_write_cmos_sensor(0x5812, 0x07);
	OV3660_write_cmos_sensor(0x5813, 0x03);
	OV3660_write_cmos_sensor(0x5814, 0x00);
	OV3660_write_cmos_sensor(0x5815, 0x00);
	OV3660_write_cmos_sensor(0x5816, 0x02);
	OV3660_write_cmos_sensor(0x5817, 0x06);
	OV3660_write_cmos_sensor(0x5818, 0x09);
	OV3660_write_cmos_sensor(0x5819, 0x07);
	OV3660_write_cmos_sensor(0x581a, 0x05);
	OV3660_write_cmos_sensor(0x581b, 0x05);
	OV3660_write_cmos_sensor(0x581c, 0x06);
	OV3660_write_cmos_sensor(0x581d, 0x09);
	OV3660_write_cmos_sensor(0x581e, 0x1d);
	OV3660_write_cmos_sensor(0x581f, 0x0f);
	OV3660_write_cmos_sensor(0x5820, 0x0c);
	OV3660_write_cmos_sensor(0x5821, 0x0c);
	OV3660_write_cmos_sensor(0x5822, 0x0e);
	OV3660_write_cmos_sensor(0x5823, 0x1a);
	//;r/b
	OV3660_write_cmos_sensor(0x5824, 0x24);
	OV3660_write_cmos_sensor(0x5825, 0x08);
	OV3660_write_cmos_sensor(0x5826, 0x0a);
	OV3660_write_cmos_sensor(0x5827, 0x28);
	OV3660_write_cmos_sensor(0x5828, 0x26);
	OV3660_write_cmos_sensor(0x5829, 0x28);
	OV3660_write_cmos_sensor(0x582a, 0x26);
	OV3660_write_cmos_sensor(0x582b, 0x24);
	OV3660_write_cmos_sensor(0x582c, 0x26);
	OV3660_write_cmos_sensor(0x582d, 0x0a);
	OV3660_write_cmos_sensor(0x582e, 0x08);
	OV3660_write_cmos_sensor(0x582f, 0x42);
	OV3660_write_cmos_sensor(0x5830, 0x40);
	OV3660_write_cmos_sensor(0x5831, 0x42);
	OV3660_write_cmos_sensor(0x5832, 0x28);
	OV3660_write_cmos_sensor(0x5833, 0x2a);
	OV3660_write_cmos_sensor(0x5834, 0x26);
	OV3660_write_cmos_sensor(0x5835, 0x24);
	OV3660_write_cmos_sensor(0x5836, 0x26);
	OV3660_write_cmos_sensor(0x5837, 0x0a);
	OV3660_write_cmos_sensor(0x5838, 0x22);
	OV3660_write_cmos_sensor(0x5839, 0x28);
	OV3660_write_cmos_sensor(0x583a, 0x0a);
	OV3660_write_cmos_sensor(0x583b, 0x28);
	OV3660_write_cmos_sensor(0x583c, 0x24);
	//;r/b gain
...
//blc
	...
	OV3660_write_cmos_sensor(0x3405, 0x24);
     ...
     //add by maliyan  for W7005 2011-12-06
	//fPS
	...
	//EV
	OV3660_write_cmos_sensor(0x3a0f, 0x45); 
	OV3660_write_cmos_sensor(0x3a10, 0x3a); 
	OV3660_write_cmos_sensor(0x3a1b, 0x45);  
	OV3660_write_cmos_sensor(0x3a1e, 0x3a);  
	OV3660_write_cmos_sensor(0x3a11, 0x60);  
	OV3660_write_cmos_sensor(0x3a1f, 0x20);  
	OV3660_write_cmos_sensor(0x3a18, 0x00); 
	...
	OV3660_write_cmos_sensor(0x5184, 0x25);  
	OV3660_write_cmos_sensor(0x5185, 0x24);  
	OV3660_write_cmos_sensor(0x5186, 0x0d); 
	OV3660_write_cmos_sensor(0x5187, 0x12);  
	OV3660_write_cmos_sensor(0x5188, 0x0d); 
	OV3660_write_cmos_sensor(0x5189, 0x80);  
	OV3660_write_cmos_sensor(0x518a, 0x70);  
	OV3660_write_cmos_sensor(0x518b, 0xbb);  
	OV3660_write_cmos_sensor(0x518c, 0x1a);  
	OV3660_write_cmos_sensor(0x518d, 0x40);  
	OV3660_write_cmos_sensor(0x518e, 0x30);  
	OV3660_write_cmos_sensor(0x518f, 0x5c);  
	OV3660_write_cmos_sensor(0x5190, 0x4a);  
	OV3660_write_cmos_sensor(0x5191, 0xf8);  
	OV3660_write_cmos_sensor(0x5192, 0x04); 
	OV3660_write_cmos_sensor(0x5193, 0x70);  
	OV3660_write_cmos_sensor(0x5194, 0xf0);  
	...
	OV3660_write_cmos_sensor(0x5197, 0x01); 
	OV3660_write_cmos_sensor(0x5198, 0x05); 
	OV3660_write_cmos_sensor(0x5199, 0xf6);  
	OV3660_write_cmos_sensor(0x519a, 0x04); 
	OV3660_write_cmos_sensor(0x519b, 0x00); 
	OV3660_write_cmos_sensor(0x519c, 0x04); 
	OV3660_write_cmos_sensor(0x519d, 0xe4);  
	OV3660_write_cmos_sensor(0x519e, 0x38);  
	...
	//;gamma
	OV3660_write_cmos_sensor(0x5490, 0x20); 
	OV3660_write_cmos_sensor(0x5481, 0x10);  
	OV3660_write_cmos_sensor(0x5482, 0x17);  
	OV3660_write_cmos_sensor(0x5483, 0x23);  
	OV3660_write_cmos_sensor(0x5484, 0x3d);  
	OV3660_write_cmos_sensor(0x5485, 0x49);  
	OV3660_write_cmos_sensor(0x5486, 0x58);  
	OV3660_write_cmos_sensor(0x5487, 0x62);  
	OV3660_write_cmos_sensor(0x5488, 0x6c);  
	OV3660_write_cmos_sensor(0x5489, 0x77);  
	OV3660_write_cmos_sensor(0x548a, 0x81);  
	OV3660_write_cmos_sensor(0x548b, 0x93);  
	OV3660_write_cmos_sensor(0x548c, 0xa3);  
	OV3660_write_cmos_sensor(0x548d, 0xbe);  
	OV3660_write_cmos_sensor(0x548e, 0xd6);  
	OV3660_write_cmos_sensor(0x548f, 0xe8);   
	...
	OV3660_write_cmos_sensor(0x5580, 0x02); 
	OV3660_write_cmos_sensor(0x5583, 0x40);
	OV3660_write_cmos_sensor(0x5584, 0x35);
	...
	OV3660_write_cmos_sensor(0x5823, 0x1a);
	//;r/b
	OV3660_write_cmos_sensor(0x5824, 0x22);
	OV3660_write_cmos_sensor(0x5825, 0x06);
	OV3660_write_cmos_sensor(0x5826, 0x05);
	OV3660_write_cmos_sensor(0x5827, 0x24);
	OV3660_write_cmos_sensor(0x5828, 0x25);
	OV3660_write_cmos_sensor(0x5829, 0x26);
	OV3660_write_cmos_sensor(0x582a, 0x24);
	OV3660_write_cmos_sensor(0x582b, 0x23);
	OV3660_write_cmos_sensor(0x582c, 0x22);
	OV3660_write_cmos_sensor(0x582d, 0x05);
	OV3660_write_cmos_sensor(0x582e, 0x07);
	OV3660_write_cmos_sensor(0x582f, 0x43);
	OV3660_write_cmos_sensor(0x5830, 0x40);
	OV3660_write_cmos_sensor(0x5831, 0x42);
	OV3660_write_cmos_sensor(0x5832, 0x02);
	OV3660_write_cmos_sensor(0x5833, 0x28);
	OV3660_write_cmos_sensor(0x5834, 0x26);
	OV3660_write_cmos_sensor(0x5835, 0x23);
	OV3660_write_cmos_sensor(0x5836, 0x24);
	OV3660_write_cmos_sensor(0x5837, 0x07);
	OV3660_write_cmos_sensor(0x5838, 0x28);
	OV3660_write_cmos_sensor(0x5839, 0x26);
	OV3660_write_cmos_sensor(0x583a, 0x07);
	OV3660_write_cmos_sensor(0x583b, 0x25);
	OV3660_write_cmos_sensor(0x583c, 0x22);
	//;r/b gain
	OV3660_write_cmos_sensor(0x583d, 0xce);
	...
	OV3660_write_cmos_sensor(0x5305, 0x30);
	OV3660_write_cmos_sensor(0x5306, 0x08);
	OV3660_write_cmos_sensor(0x5307, 0x30);
...
//	  OV3660_write_cmos_sensor(0x303B, 0x1B); //0X14
	...
	OV3660_write_cmos_sensor(0x4520,0xb0);
	 //
#if defined(SIMCOM_I706M)
	 OV3660_write_cmos_sensor(0x3820, 0x40);//40//0x46
	 OV3660_write_cmos_sensor(0x3821, 0x06);//06
	 OV3660_write_cmos_sensor(0x4514, 0xbb);//0x88
#else
	 OV3660_write_cmos_sensor(0x3820, 0x46);//40//0x46
	 OV3660_write_cmos_sensor(0x3821, 0x00);//06
	 OV3660_write_cmos_sensor(0x4514, 0x88);//0x88
#endif
...
#if defined(SIMCOM_I706M)
#else
	OV3660_HVMirror(IMAGE_HV_MIRROR);
#endif
//       OV3660_write_cmos_sensor(0x3008,0x02); 
...
#if defined(I5000_P150)||defined(I5000_P14)
	OV3660_write_cmos_sensor(0x5302,0x18);//58
	OV3660_write_cmos_sensor(0x5303,0x03);//48
	OV3660_write_cmos_sensor(0x5306,0x10);//0x09
	OV3660_write_cmos_sensor(0x5307,0x30);//0x16
...
//	Out->WaitStableFrameNum =1;
	...
	//20111220 for solve manual aw issue
	...
	mdelay(100);   //20111220 for coninue snap
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  kal_uint16 DummyPixel;
   kal_uint8 temp_AE_reg;
    kal_uint8 OV3660_gain_h = 0, OV3660_gain_l = 0;  //add for continue snap
  ...
  volatile kal_uint32 shutter = OV3660_exposure_lines,gain, temp_reg;
	...
	//OV3660_HVMirror(ACDK_SENSOR_IMAGE_HV_MIRROR);		
		...
		OV3660_gain_h = OV3660_read_cmos_sensor(0x350a);
		OV3660_gain_l= OV3660_read_cmos_sensor(0x350b);
...
#if 1  //maliyan modiy  for burstshot  2011-12-23

	if(!enter_preview_flag)//if(is_cotinueSnap)
	{
		...
		OV3660_write_cmos_sensor(0x350a,OV3660_gain_h);
		OV3660_write_cmos_sensor(0x350b,OV3660_gain_l);
		
              mdelay(200); //delay 1frame
	}

	
#endif
       enter_preview_flag=FALSE;
#if defined(VOTO_W5300)
	OV3660_HVMirror(IMAGE_HV_MIRROR);//(IMAGE_NORMAL);//(IMAGE_V_MIRROR);//(IMAGE_HV_MIRROR);// lifei
#endif
}
	...
	switch (para)
	{
		...
		case AWB_MODE_DAYLIGHT: //sunny
			...
			*/
			...
			OV3660_write_cmos_sensor(0x3400,0x07);//AWB R Gain: Reg0x3400[3:0] : Reg0x3401[7:0]
...
static BOOL OV3660_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_NEGATIVE:// TODO:
			...
			OV3660_write_cmos_sensor(0x5580,(reg5580&(~0x58)));// TODO: Check with FAE

			OV3660_write_cmos_sensor(0x3212,0x03);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5580,0x46);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5583,0x40);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5584,0x28);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5003,0x08);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0x13);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0xa3);/*U Channel Gain*/
		...
		case MEFFECT_SEPIABLUE:// TODO:
			...
			OV3660_write_cmos_sensor(0x5584,0x68);	// Channel Gain
			*/
			OV3660_write_cmos_sensor(0x5583,0xa0);//U Channel Gain
			OV3660_write_cmos_sensor(0x5584,0x40);	// Channel Gain
			break;
	...
	switch (para)
	{
		case MEFFECT_OFF:
			...
			OV3660_write_cmos_sensor(0x3212,0x03);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5580,0x06);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5583,0x40);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5584,0x28);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5003,0x08);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0x13);/*U Channel Gain*/
		...
		case MEFFECT_MONO:
				OV3660_write_cmos_sensor(0x3212,0x03);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5580,0x1e);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5583,0x80);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5584,0x80);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5003,0x08);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0x13);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0xa3);/*U Channel Gain*/
		...
		case MEFFECT_SEPIAGREEN:// 
				OV3660_write_cmos_sensor(0x3212,0x03);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5580,0x1e);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5583,0x60);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5584,0x60);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5003,0x08);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0x13);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0xa3);/*U Channel Gain*/
		...
		case MEFFECT_SEPIABLUE:// 
				OV3660_write_cmos_sensor(0x3212,0x03);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5580,0x1e);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x5583,0xa0);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5584,0x40);	/*V Channel Gain*/
			OV3660_write_cmos_sensor(0x5003,0x08);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0x13);/*U Channel Gain*/
			OV3660_write_cmos_sensor(0x3212,0xa3);/*U Channel Gain*/
